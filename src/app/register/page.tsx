...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setLoading(false);
      if (loginRes?.error) { setError("Registration succeeded but login failed. Please sign in."); return; }
    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--bg-base)", padding: "24px" }}>
      ...
      <div className="animate-scale-in" style={{ width: "100%", maxWidth: "420px" }}>
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <p style={{ fontSize: "13px", color: "var(--text-faint)" }}>Android Club · Create your account</p>
        </div>
        ...
        >
          <div>
            <label style={{ fontSize: "11px", fontWeight: 700, color: "var(--text-faint)", textTransform: "uppercase", letterSpacing: "0.08em", fontFamily: "var(--font-mono)", display: "block", marginBottom: "7px" }}>Full Name</label>
            <input
              value={name}
          ...
          <p style={{ textAlign: "center", fontSize: "13px", color: "var(--text-faint)", marginTop: "4px" }}>
            ...
            <Link href="/login" style={{ color: "#86efac", fontWeight: 600 }}>Sign in</Link>
          </p>
        </form>
      </div>
    </div>
